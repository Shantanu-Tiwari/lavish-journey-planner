...
const WhatsAppButton = () => {
  const handleWhatsAppClick = () => {
    window.open('https://wa.me/919958530029', '_blank');
  };
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] pointer-events-auto">
      ...
      <div className="absolute inset-2 rounded-full bg-[#25D366] animate-ping opacity-30 animation-delay-75 pointer-events-none"></div>
    </div>
  );
};
